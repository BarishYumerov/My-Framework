...
class hallsRepository
{
    ...
    public function findAll()
    {
        ...
        $this->query = "SELECT * FROM ConferenceScheduler.halls" . $this->where . $this->order;
...
$entityInfo['id']);
    ...
    public function findOne()
    {
        ...
        $this->query = "SELECT * FROM ConferenceScheduler.halls" . $this->where . $this->order . " LIMIT 1";
        $result = $db->prepare($this->query);
        $result->execute([]);
...
$entityInfo['id']);
    ...
    public function delete()
    {
        ...
        $this->query = "DELETE FROM ConferenceScheduler.halls" . $this->where;
        $result = $db->prepare($this->query);
